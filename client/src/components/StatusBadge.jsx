...
const toneByValue = {
  OPERATIONAL: "bg-emerald-950 text-emerald-300 ring-emerald-700/50",
  ...
  COMPLETED: "bg-emerald-950 text-emerald-300 ring-emerald-700/50",
  ...
  APPROVED: "bg-emerald-950 text-emerald-300 ring-emerald-700/50",
